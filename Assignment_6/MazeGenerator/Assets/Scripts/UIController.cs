...
public class UIController : MonoBehaviour {
    ...
    void Awake() {
        ...
        // Find settings
        grid = gameObject.transform.Find("GridSize").gameObject;
        algorithm = gameObject.transform.Find("AlgorithmSelect").gameObject;
        generate = gameObject.transform.Find("Generate").gameObject;   
    }
